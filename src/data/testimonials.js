...
const person5 = {
  name: 'David Issabell',
  paragraph: 'We needed to create an iOS app to calculate gas turbine performance and availability based on the user’s selection. Appish Technologies developed an iOS app with the required calculation functions.',
  company: 'Product Designer at Uber.INC',
  image: orange
}
