...
const Testimonials = () => {
  return (
    <section id='testimonials' className=' pb-[60px] w-[90%] flex flex-col items-center justify-center text-center mx-auto max-w-[1100px] md:pt-[100px] lg:pb-[150px] lg:w-[85%]'>
