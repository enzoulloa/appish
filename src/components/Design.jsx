...
const Design = () => {
  return (
    <section className=' w-[90%] pt-[80px] pb-[80px] flex flex-col max-w-[1100px] mx-auto justify-between items-center md:w-[85%] md:pb-[100px] md:pt-[100px] lg:flex-row lg:pt-[100px]'>
      <Phone />
      <div className=' w-full md:w-[75%] lg:w-[43%]'>
