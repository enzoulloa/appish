    ...
    <section className=' overflow-hidden '>
      <div className=' pb-[50px] w-[90%] pt-[80px] max-w-[1100px] mx-auto md:w-[85%] md:pt-[100px] '>
        <div className=' flex w-full items-center justify-center relative'>
          <div className='absolute top-[6%] w-[160px] h-[160px] right-0 left-auto bottom-auto md:w-[270px] md:h-[270px] md:top-[5%]'>
            <img className='overflow-visible object-contain w-full h-full max-w-full align-middle' src={blue} alt='Blue circle' />
          </div>
          <div className=' absolute w-[110px] h-[110px] left-[5%] top-auto right-auto bottom-[3%] md:w-[200px] md:h-[200px]'>
