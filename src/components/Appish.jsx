  ...
  return (
    <section className=' pt-[140px] max-w-[960px] pb-[50px] flex justify-center text-center flex-col mx-auto items-center md:pt-[180px] lg:pt-[260px]'>
      ...
      <div className='w-[90%] mt-[30px] flex justify-center items-center text-center md:mt-[40px] '>
        <a className='w-[45%] h-[60px] md:w-[185px] md:h-[55px]' href='https://webflow.com/'><img className='h-full' src={app} alt='AppStore' loading='eager' /></a>
        <a className='w-[45%] h-[60px] ml-[10px]  md:w-[185px] md:h-[55px] md:ml-[15px]' href='https://webflow.com/'><img className='h-full' src={google} alt='GooglePlay' loading='eager' /></a>
      </div>
    </section>
  )
}
