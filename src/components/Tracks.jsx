...
const Tracks = () => {
  return (
    <section className='pt-[110px] max-w-[950px] flex flex-col text-center justify-center w-[90%] pb-20 mx-auto items-center md:pt-[100px] md:pb-[100px] md:w-[80%] lg:w-[85%]'>
