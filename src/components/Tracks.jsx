...
const Tracks = () => {
  return (
    <section id='features' className='pt-[110px] max-w-[950px] flex flex-col text-center justify-center w-[90%] pb-20 mx-auto items-center md:pt-[100px] md:pb-[100px] md:w-[80%] lg:w-[85%]'>
      <h2 className=' text-[26px] leading-[110%] text-[#231656] font-extrabold md:text-[48px]'> Show the true value of your product.</h2>
      <p className=' w-[80%] mt-[30px] text-[#6f6a80] leading-[150%] md:w-[90%] md:text-[20px] font-medium lg:w-[60%]'>Stop letting feature-dumps stop your visitors from seeing the impact your finance product can make on their lives. Build a better website with Appish.</p>
      <div className=' w-[90%] mt-[50px] grid gap-y-[70px] gap-x-[40px] grid-cols-1 items-start text-center md:mt-[60px] md:w-full md:grid-cols-3 md:gap-y-4 lg:mt-[100px] lg:gap-x-[70px]'>
